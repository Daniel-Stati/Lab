...
const carCards: Car[] = [
  ...
  {
    producator: 'Ghost blade',
    model: 'E175',
    capacitate: 80,
    nivelCombustibil: 0.5,
    esteInZbor: false,
    image: "/host.jpg"
  }
]
      ...
      <Layout className="site-layout">
        ...
        <Content style={{ margin: '0 16px' }}>
          <Breadcrumb style={{ margin: '16px 0' }}>
            ...
            <Breadcrumb.Item>Daniel</Breadcrumb.Item>
          </Breadcrumb>
            ...
            <Row justify="center" gutter={16} >
              {carCards.map((car, index) => (
                <Col key={index} span={6}>
                    ...
                    <p>Denumire arma: {car. producator}</p>
                   
                    <p>Lungime arma(cm): {car.capacitate}</p>
                    <p>Greutate(kg): {car.nivelCombustibil}</p>
